    ...
    class b {
      ...
      emStrong(e, t, n = "") {
        ...
        if (!(s[1] || s[2] || "") || !n || this.rules.inline.punctuation.exec(n)) {
          ...
          for (a.lastIndex = 0, t = t.slice(-1 * e.length + s[0].length - 1); null != (s = a.exec(t)); ) {
      ...
      #e(e, t) {
        return (n, s) => {
          ...
          !0 === this.defaults.async &&
            !1 === r.async &&
            (i.silent || console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),
            (i.async = !0));
