define("/js/color_convert.js", async (require, exports) => {
  var canvas, context;
  ...
  exports.to_rgba_array = function (color) {
    /**
  ...
  exports.to_rgba = function (color) {
    /**
     ...
     */
    var a = exports.to_rgba_array(color);
    return "rgba(" + a[0] + "," + a[1] + "," + a[2] + "," + a[3] / 255 + ")";
  };

  exports.to_hex = function (color) {
    /**
