    ...
    return (function () {
          ...
          return (
            (t.reportNonstrict = function (e, t, r) {
              ...
              if (("function" == typeof a && (a = a(e, t, r)), a && "ignore" !== a)) {
                ...
                "warn" === a
                  ? "undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + t + " [" + e + "]")
            ...
            (t.useStrictBehavior = function (e, t, r) {
              ...
              return (
                ...
                (!0 === n ||
                  "error" === n ||
                  ("warn" === n
                    ? ("undefined" != typeof console && console.warn("LaTeX-incompatible input and strict mode is set to 'warn': " + t + " [" + e + "]"), !1)
                    : ("undefined" != typeof console &&
      ...
      function N(e, t, r) {
        ...
        var n = e.charCodeAt(0),
          a = T[t][n];
        if ((!a && e[0] in C && ((n = C[e[0]].charCodeAt(0)), (a = T[t][n])), a || "text" !== r || (S(n) && (a = T[t][77])), a))
        ...
        O = (function () {
          ...
          return (
            ...
            (t.havingSize = function (e) {
              return this.size === e && this.textSize === e ? this : this.extend({ style: this.style.text(), size: e, textSize: e, sizeMultiplier: R[e - 1] });
            }),
        ...
        Ke = {
          ...
          staticSvg: function (e, t) {
            var r = Ze[e],
              ...
              i = r[2],
              o = new J(n),
              s = new K([o], { width: F(a), height: F(i), style: "width:" + F(a), viewBox: "0 0 " + 1e3 * a + " " + 1e3 * i, preserveAspectRatio: "xMinYMin" }),
              l = We(["overlay"], [s], t);
      ...
      var zt = (function () {
        ...
        Bt = function (e, t, r) {
          return (
            !ae[t][e] ||
              ...
              (we.hasOwnProperty(e) && r && ((r.fontFamily && "tt" === r.fontFamily.slice(4, 6)) || (r.font && "tt" === r.font.slice(4, 6)))) ||
              (e = ae[t][e].replace),
            new Tt.TextNode(e)
          );
        },
        ...
        Nt = function (e, t) {
          ...
          return l.contains(["\\imath", "\\jmath"], a)
            ? null
            : (ae[n][a] && ae[n][a].replace && (a = ae[n][a].replace), N(a, Ke.fontMap[r].fontName, n) ? Ke.fontMap[r].variant : null);
        },
        qt = function (e, t, r) {
          if (1 === e.length) {
            var n = Rt(e[0], t);
      ...
      var Ot = function (e) {
          return new E({ style: e.displayMode ? x.DISPLAY : x.TEXT, maxSize: e.maxSize, minRuleThickness: e.minRuleThickness });
        },
        Et = function (e, t) {
          if (t.displayMode) {
            var r = ["katex-display"];
        ...
        Pt = function (e, t, r, n, a) {
          ...
          if (/fbox|color|angl/.test(t)) {
            ...
            var l = [];
            /^[bx]cancel$/.test(t) && l.push(new Q({ x1: "0", y1: "0", x2: "100%", y2: "100%", "stroke-width": "0.046em" })),
              /^x?cancel$/.test(t) && l.push(new Q({ x1: "0", y1: "100%", x2: "100%", y2: "0", "stroke-width": "0.046em" }));
        ...
        Gt = function (e, t) {
          var r = (function () {
              ...
              if (l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                ...
                if (s > 5)
                  "widehat" === n || "widecheck" === n ? ((a = 420), (r = 2364), (o = 0.42), (i = n + "4")) : ((a = 312), (r = 2340), (o = 0.34), (i = "tilde4"));
                else {
                  var h = [1, 1, 2, 2, 3, 3][s];
                  "widehat" === n || "widecheck" === n
                    ? ((r = [0, 1062, 2364, 2364, 2364][h]), (a = [0, 239, 300, 360, 420][h]), (o = [0, 0.24, 0.3, 0.3, 0.36, 0.42][h]), (i = n + h))
                    : ((r = [0, 600, 1033, 2339, 2340][h]), (a = [0, 260, 286, 306, 312][h]), (o = [0, 0.26, 0.286, 0.3, 0.306, 0.34][h]), (i = "tilde" + h));
                }
                var c = new J(i),
                  m = new K([c], { width: "100%", height: F(o), viewBox: "0 0 " + r + " " + a, preserveAspectRatio: "none" });
              ...
              for (var k = 0; k < w; k++) {
                var S = new J(v[k]),
                  M = new K([S], { width: "400em", height: F(x), viewBox: "0 0 " + r + " " + y, preserveAspectRatio: p[k] + " slice" }),
      ...
      var Wt = function (e, t) {
          ...
          if (n.isStretchy)
            ...
            "\\vec" === n.label
              ...
              : (((u = ee((u = Ke.makeOrd({ mode: n.mode, text: n.label }, t, "textord")))).italic = 0), (p = u.width), c && (m += u.depth)),
        ...
        ot({
          ...
          handler: function (e, t) {
            var r = t[0],
              n = e.parser.mode;
            return (
              "math" === n && (e.parser.settings.reportNonstrict("mathVsTextAccents", "LaTeX's accent " + e.funcName + " works only in text mode"), (n = "text")),
      ...
      ot({
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = e.funcName,
            a = t[0];
          return { type: "mclass", mode: r.mode, mclass: "m" + n.slice(5), body: ht(a), isCharacterBox: l.isCharacterBox(a) };
        },
        htmlBuilder: Kt,
        mathmlBuilder: Jt
      });
      ...
      ot({
        ...
        props: { numArgs: 2 },
        handler: function (e, t) {
          return { type: "mclass", mode: e.parser.mode, mclass: Qt(t[0]), body: ht(t[1]), isCharacterBox: l.isCharacterBox(t[1]) };
        }
      }),
        ot({
          type: "mclass",
      ...
      var er = { ">": "\\\\cdrightarrow", "<": "\\\\cdleftarrow", "=": "\\\\cdlongequal", A: "\\uparrow", V: "\\downarrow", "|": "\\Vert", ".": "no arrow" },
        tr = function (e) {
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          ...
          return n.classes.push("cd-label-" + e.side), (n.style.bottom = F(0.8 - n.depth)), (n.height = 0), (n.depth = 0), n;
        },
        mathmlBuilder: function (e, t) {
      ...
      var lr = function (e, t, r) {
        ...
        ur = function (e, t, r) {
          ...
          return (
            ...
            { type: "elem", elem: Ke.makeSpan(["delimsizinginner", n], [Ke.makeSpan([], [Ke.makeSymbol(e, t, r)])]) }
          );
        },
        pr = function (e, t, r) {
        ...
        vr = function (e, t, r, n, a, i) {
          ...
          "\\uparrow" === e
            ...
            : "\\lmoustache" === e || "\u23b0" === e
            ? ((o = "\u23a7"), (c = "\u23ad"), (h = "\u23aa"), (p = "Size4-Regular"))
            : ("\\rmoustache" !== e && "\u23b1" !== e) || ((o = "\u23ab"), (c = "\u23a9"), (h = "\u23aa"), (p = "Size4-Regular"));
          var d = lr(o, p, a),
            f = d.height + d.depth,
            g = lr(h, p, a),
            v = g.height + g.depth,
        ...
        yr = function (e, t, r, n, a) {
          var i = (function (e, t, r) {
            ...
            o = new J(e, i),
            s = new K([o], { width: "400em", height: F(t), viewBox: "0 0 400000 " + r, preserveAspectRatio: "xMinYMin slice" });
        ...
        zr = [{ type: "small", style: x.SCRIPTSCRIPT }, { type: "small", style: x.SCRIPT }, { type: "small", style: x.TEXT }, { type: "stack" }],
        Ar = [
          { type: "small", style: x.SCRIPTSCRIPT },
          { type: "small", style: x.SCRIPT },
          { type: "small", style: x.TEXT },
            ...
            return (
              "small" === i.type
                ...
                ? ((c = 1080 * Sr[i.size]),
                  ...
                  (n = 1 / o))
                : ((l = e + s + br), (h = e + s), (c = Math.floor(1e3 * e + s) + 80), ((r = yr("sqrtTall", l, c, s, t)).style.minWidth = "0.742em"), (n = 1.056)),
              (r.height = h),
              (r.style.height = F(l)),
      ...
      ot({
        ...
        handler: function (e, t) {
          var r = Rr(t[0], e);
          return { type: "delimsizing", mode: e.parser.mode, size: qr[e.funcName].size, mclass: qr[e.funcName].mclass, delim: r.text };
        },
        htmlBuilder: function (e, t) {
      ...
      var Or = function (e, t) {
          ...
          if ("sout" === o) ((r = Ke.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s), (h = -0.5 * t.fontMetrics().xHeight);
          else if ("phase" === o) {
            ...
            var d = Math.floor(1e3 * p * s),
              ...
              g = new K([new J("phase", f)], { width: "400em", height: F(d / 1e3), viewBox: "0 0 400000 " + d, preserveAspectRatio: "xMinYMin slice" });
            ...
            var v = 0,
              ...
              y = 0;
            /box/.test(o)
              ? ((y = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness)), (b = v = t.fontMetrics().fboxsep + ("colorbox" === o ? 0 : y)))
              : "angl" === o
              ? ((v = 4 * (y = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness))), (b = Math.max(0, 0.25 - i.depth)))
              : (b = v = c ? 0.2 : 0),
              (r = Pt(i, o, v, b, t)),
              /fbox|boxed|fcolorbox/.test(o)
                ? ((r.style.borderStyle = "solid"), (r.style.borderWidth = F(y)))
                : "angl" === o && 0.049 !== y && ((r.style.borderTopWidth = F(y)), (r.style.borderRightWidth = F(y))),
              (h = i.depth + b),
      ...
      function Dr(e) {
        for (
          var t = e.type,
            ...
            i = e.htmlBuilder,
            o = e.mathmlBuilder,
            s = { type: t, numArgs: n.numArgs || 0, allowedInText: !1, numOptionalArgs: 0, handler: a },
            l = 0;
          l < r.length;
          ++l
        )
        ...
        function w() {
          y &&
            (e.gullet.macros.get("\\df@tag")
              ? (y.push(e.subparse([new Gr("\\df@tag")])), e.gullet.macros.set("\\df@tag", void 0, !0))
      ...
      var jr = function (e, t) {
          var r,
            ...
            p = 5 * u;
          e.colSeparationType && "small" === e.colSeparationType && (p = (t.havingStyle(x.SCRIPT).sizeMultiplier / t.sizeMultiplier) * 0.2778);
          var d = "CD" === e.colSeparationType ? P({ number: 3, unit: "ex" }, t) : 12 * u,
            ...
            y = 0;
          function w(e) {
            for (var t = 0; t < e.length; ++t) t > 0 && (y += 0.25), c.push({ pos: y, isDashed: e[t] });
          }
          ...
          for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
            for (var V = I[N] || {}, G = !0; "separator" === V.type; ) {
              if (
                (G || (((C = Ke.makeSpan(["arraycolsep"], [])).style.width = F(t.fontMetrics().doubleRuleSep)), R.push(C)),
          ...
          if (((h = Ke.makeSpan(["mtable"], R)), c.length > 0)) {
            for (var K = Ke.makeLineSpan("hline", t, m), J = Ke.makeLineSpan("hdashline", t, m), Q = [{ type: "elem", elem: h, shift: 0 }]; c.length > 0; ) {
              var ee = c.pop(),
                te = ee.pos - q;
          ...
          if (e.cols && e.cols.length > 0) {
            ...
            for (var b = g; b < v; b++)
              "align" === p[b].type
                ...
                : "separator" === p[b].type && f && ((d += "|" === p[b].separator ? "solid " : "dashed "), (f = !1));
      ...
      Dr({
        ...
        Dr({
          ...
          handler: function (e) {
            ...
            return (
              ...
              t ? { type: "leftright", mode: e.mode, body: [o], left: t[0], right: t[1], rightColor: void 0 } : o
            );
          },
          htmlBuilder: jr,
          mathmlBuilder: Zr
        ...
        Dr({ type: "array", names: ["align", "align*", "aligned", "split"], props: { numArgs: 0 }, handler: Kr, htmlBuilder: jr, mathmlBuilder: Zr }),
        Dr({
          type: "array",
        ...
        Dr({ type: "array", names: ["alignat", "alignat*", "alignedat"], props: { numArgs: 1 }, handler: Kr, htmlBuilder: jr, mathmlBuilder: Zr }),
        Dr({
          type: "array",
          ...
          handler: function (e) {
            Yr(e);
            var t = { autoTag: Xr(e.envName), emptySingleRow: !0, singleRow: !0, maxNumCols: 1, leqno: e.parser.settings.leqno };
            return Wr(e.parser, t, "display");
          },
          htmlBuilder: jr,
          mathmlBuilder: Zr
              ...
              (function (e) {
                ...
                return (
                  ...
                  e.gullet.endGroup(),
                  {
                    ...
                    addJot: !0,
                    rowGaps: [null],
                    cols: new Array(s[0].length).fill({ type: "align", align: "c", pregap: 0.25, postgap: 0.25 }),
      ...
      ot({
        ...
        ot({
          ...
          handler: function (e, t) {
            ...
            return { type: "mclass", mode: r.mode, mclass: Qt(n), body: [{ type: "font", mode: r.mode, font: "boldsymbol", body: n }], isCharacterBox: a };
          }
        }),
        ot({
          type: "font",
      ...
      var rn = function (e, t) {
        ...
        nn = function (e, t) {
          ...
          if (
            (e.hasBarLine
              ? (e.barSize ? ((c = P(e.barSize, t)), (h = Ke.makeLineSpan("frac-line", t, c))) : (h = Ke.makeLineSpan("frac-line", t)),
                (c = h.height),
                (m = h.height))
      ...
      ot({
        ...
        handler: function (e, t) {
          ...
          return { type: "genfrac", mode: n.mode, numer: a, denom: i, continued: !1, hasBarLine: r, barSize: m, leftDelim: s, rightDelim: h, size: u };
        },
        htmlBuilder: nn,
        mathmlBuilder: an
      }),
        ot({
          ...
          handler: function (e, t) {
            ...
            return { type: "infix", mode: r.mode, replaceWith: "\\\\abovefrac", size: Ut(t[0], "size").value, token: n };
          }
        }),
        ot({
          type: "genfrac",
      ...
      var ln = function (e, t) {
        var r,
          ...
          a = t.style;
        "supsub" === e.type
          ? ((r = e.sup ? wt(e.sup, t.havingStyle(a.sup()), t) : wt(e.sub, t.havingStyle(a.sub()), t)), (n = Ut(e.base, "horizBrace")))
          : (n = Ut(e, "horizBrace"));
        var i,
      ...
      ot({
        ...
        ot({
          ...
          handler: function (e, t) {
            var r = e.parser,
              n = t[1],
              a = Ut(t[0], "url").url;
            return r.settings.isTrusted({ command: "\\href", url: a }) ? { type: "href", mode: r.mode, href: a, body: ht(n) } : r.formatUnsupportedCmd("\\href");
          },
          htmlBuilder: function (e, t) {
            var r = ft(e.body, t, !1);
        ...
        ot({
          ...
          handler: function (e, t) {
            ...
            return a.settings.isTrusted(r) ? { type: "html", mode: a.mode, attributes: l, body: ht(s) } : a.formatUnsupportedCmd(i);
          },
          htmlBuilder: function (e, t) {
            var r = ft(e.body, t, !1),
              n = ["enclosing"];
      ...
      ot({
        ...
        handler: function (e, t, r) {
          ...
          return (
            ...
            a.settings.isTrusted({ command: "\\includegraphics", url: p })
              ? { type: "includegraphics", mode: a.mode, alt: l, width: i, height: o, totalheight: s, src: p }
        ...
        mathmlBuilder: function (e, t) {
          ...
          var n = P(e.height, t),
            a = 0;
          if (
            (e.totalheight.number > 0 && ((a = P(e.totalheight, t) - n), r.setAttribute("valign", F(-a))), r.setAttribute("height", F(n + a)), e.width.number > 0)
          ) {
            var i = P(e.width, t);
          ...
          handler: function (e, t) {
            ...
            if (r.settings.strict) {
              var i = "m" === n[1],
                o = "mu" === a.value.unit;
              i
                ? (o || r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " supports only mu units, not " + a.value.unit + " units"),
      ...
      ot({
        ...
        handler: function (e, t) {
          return { type: "mathchoice", mode: e.parser.mode, display: ht(t[0]), text: ht(t[1]), script: ht(t[2]), scriptscript: ht(t[3]) };
        },
        htmlBuilder: function (e, t) {
          var r = cn(e, t),
            n = ft(r, t, !1);
      ...
      var mn = function (e, t, r, n, a, i, o) {
        ...
        pn = function (e, t) {
          ...
          return (
            ...
            i ? mn(o, r, n, t, s, b, v) : (v && ((o.style.position = "relative"), (o.style.top = F(v))), o)
          );
        },
        dn = function (e, t) {
          var r;
          if (e.symbol) (r = new zt("mo", [Bt(e.name, e.mode)])), l.contains(un, e.name) && r.setAttribute("largeop", "false");
      ...
      var gn = { "\u222b": "\\int", "\u222c": "\\iint", "\u222d": "\\iiint", "\u222e": "\\oint", "\u222f": "\\oiint", "\u2230": "\\oiiint" };
      ot({
        type: "op",
        names: [
          "\\arcsin",
        ...
        ot({
          ...
          handler: function (e) {
            var t = e.parser,
              r = e.funcName;
            return 1 === r.length && (r = gn[r]), { type: "op", mode: t.mode, limits: !1, parentIsSupSub: !1, symbol: !0, name: r };
          },
          htmlBuilder: pn,
          mathmlBuilder: dn
        });
      ...
      ot({
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = e.funcName,
            a = t[0];
          return { type: "operatorname", mode: r.mode, body: ht(a), alwaysHandleSupSub: "\\operatornamewithlimits" === n, limits: !1, parentIsSupSub: !1 };
        },
        htmlBuilder: vn,
        mathmlBuilder: function (e, t) {
          ...
          htmlBuilder: function (e, t) {
            ...
            if (e.index) {
              var d = t.havingStyle(x.SCRIPTSCRIPT),
                ...
                v = Ke.makeVList({ positionType: "shift", positionData: -g, children: [{ type: "elem", elem: f }] }, t),
        ...
        htmlBuilder: function (e, t) {
          ...
          if (n && a) {
            ...
            (u = Math.max(u, i, n.depth + 0.25 * m.xHeight)),
              (v = Ke.makeVList({ positionType: "shift", positionData: -u, children: [{ type: "elem", elem: n, marginRight: y }] }, t));
          }
          ...
          if ((e.sub && i.push(Rt(e.sub, t)), e.sup && i.push(Rt(e.sup, t)), n)) a = r ? "mover" : "munder";
            ...
            if (e.sup) {
              ...
              a =
                ...
                (o && "operatorname" === o.type && o.alwaysHandleSupSub && (t.style === x.DISPLAY || o.limits))
                  ? "munderover"
                  : "msubsup";
            } else {
              var s = e.base;
              a =
                (s && "op" === s.type && s.limits && (t.style === x.DISPLAY || s.alwaysHandleSupSub)) ||
                (s && "operatorname" === s.type && s.alwaysHandleSupSub && (s.limits || t.style === x.DISPLAY))
                  ? "munder"
                  : "msub";
            }
          else {
            ...
            a =
              ...
              (l && "operatorname" === l.type && l.alwaysHandleSupSub && (l.limits || t.style === x.DISPLAY))
                ? "mover"
                : "msup";
          }
      ...
      st({
        ...
        mathmlBuilder: function (e, t) {
          var r = new Tt.MathNode("mtable", [
            new Tt.MathNode("mtr", [zn(), new Tt.MathNode("mtd", [It(e.body, t)]), zn(), new Tt.MathNode("mtd", [It(e.tag, t)])])
          ]);
          return r.setAttribute("width", "100%"), r;
        }
      });
      var An = { "\\text": void 0, "\\textrm": "textrm", "\\textsf": "textsf", "\\texttt": "texttt", "\\textnormal": "textrm" },
      ...
      Pr("\\newcommand", function (e) {
        ...
        Pr("\\show", function (e) {
          var t = e.popToken(),
            r = t.text;
          return writeObj(t, e.macros.get(r), qn[r], ae.math[r], ae.text[r]), "";
        }),
        Pr("\\bgroup", "{"),
        Pr("\\egroup", "}"),
        Pr("~", "\\nobreakspace"),
      ...
      var Yn = F(T["Main-Regular"]["T".charCodeAt(0)][1] - 0.7 * T["Main-Regular"]["A".charCodeAt(0)][1]);
          ...
          return (
            ...
            (t.parseAtom = function (t) {
              ...
              for (;;) {
                ...
                if ("\\limits" === o.text || "\\nolimits" === o.text) {
                  ...
                  "^" === this.fetch().text && h.push(this.handleSupSubscript("superscript")), (r = { type: "ordgroup", mode: this.mode, body: h });
                } else {
                  if (!$n[o.text]) break;
                  var c = $n[o.text],
                    m = jn.test(o.text);
            ...
            (t.parseGroup = function (e, t) {
              ...
              if ("{" === i || "\\begingroup" === i) {
                ...
                this.expect(o),
                  ...
                  (r = { type: "ordgroup", mode: this.mode, loc: Fr.range(a, l), body: s, semisimple: "\\begingroup" === i || void 0 });
            ...
            (t.formLigatures = function (e) {
              for (var t = e.length - 1, r = 0; r < t; ++r) {
                ...
                "-" === a &&
                  "-" === e[r + 1].text &&
                  (r + 1 < t && "-" === e[r + 2].text
                    ? (e.splice(r, 3, { type: "textord", mode: "text", loc: Fr.range(n, e[r + 2]), text: "---" }), (t -= 2))
                    : (e.splice(r, 2, { type: "textord", mode: "text", loc: Fr.range(n, e[r + 1]), text: "--" }), (t -= 1))),
                  ("'" !== a && "`" !== a) ||
                    e[r + 1].text !== a ||
                    (e.splice(r, 2, { type: "textord", mode: "text", loc: Fr.range(n, e[r + 1]), text: a + a }), (t -= 1));
              }
            }),
            (t.parseSymbol = function () {
              ...
              if ((o && ("i" === (t = t.substring(0, o.index)) ? (t = "\u0131") : "j" === t && (t = "\u0237")), ae[this.mode][t])) {
                ...
                this.settings.strict &&
                  (S(t.charCodeAt(0))
                    ? "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + t[0] + '" used in math mode', e)
              ...
              if ((this.consume(), o))
                for (var m = 0; m < o[0].length; m++) {
                  ...
                  i = { type: "accent", mode: this.mode, loc: Fr.range(e), label: p, isStretchy: !1, isShifty: !0, base: i };
                }
              return i;
            }),
            e
